...
function loadQuestion(index) {
  ...
  if (randomQuestion.inputBox) {
    ...
    document.getElementById("picdiv").classList.remove("col-md-8");
    document.getElementById("picdiv").classList.remove("col-lg-8");
    document.getElementById("picdiv").classList.remove("col-sm-8");
    document.getElementById("picdiv").classList.remove("col-xs-8");
    ...
    document.getElementById("questiondiv").classList.remove("col-md-3");
    document.getElementById("questiondiv").classList.remove("col-lg-3");
    document.getElementById("questiondiv").classList.remove("col-sm-3");
    document.getElementById("questiondiv").classList.remove("col-xs-3");
...
if (mainDiv) {
  ...
  document.getElementById("picdiv").classList.add("col-md-8");
  document.getElementById("picdiv").classList.add("col-lg-8");
  document.getElementById("picdiv").classList.add("col-sm-8");
  document.getElementById("picdiv").classList.add("col-xs-8");
    document.getElementById("questiondiv").classList.remove("input");
    document.getElementById("questiondiv").classList.add("col-md-3");
    document.getElementById("questiondiv").classList.add("col-lg-3");
    document.getElementById("questiondiv").classList.add("col-sm-3");
    document.getElementById("questiondiv").classList.add("col-xs-3");
    ...
    document.getElementById("question_background").style.height='110%';
